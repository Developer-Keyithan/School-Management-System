            ...
            <div className="w-full xl:w-1/3 flex flex-col gap-4">
                <div className="bg-white p-4 rounded-md">
                    ...
                    <div className="mt-4 flex gap-4 flex-wrap text-xs">
                        <Link className='py-3 px-5 rounded-md text-blue-600 bg-blue-200' href='/'>Student&apos;s Lessons</Link>
                        <Link className='py-3 px-5 rounded-md text-purple-600 bg-purple-200' href='/'>Student&apos;s Tearchers</Link>
                        <Link className='py-3 px-5 rounded-md text-orange-600 bg-orange-200' href='/'>Student&apos;s Exams</Link>
                        <Link className='py-3 px-5 rounded-md text-green-600 bg-green-200' href='/'>Student&apos;s Assignments</Link>
                        <Link className='py-3 px-5 rounded-md text-yellow-600 bg-yellow-200' href='/'>Student&apos;s Results</Link>
                    </div>
                </div>
                <Performance />
                <Announcements />
